...
class PhoneVerificationBloc
    extends Bloc<PhoneVerificationBlocEvent, PhoneVerificationBlocState> {
  PhoneVerificationBloc() : super(PhoneVerificationBlocState());
  var countryCode = '+91';
  var phoneNo = '';
  var gotoNext = false;
  ...
  @override
  PhoneVerificationBlocState get initialState =>
      PhoneVerificationBlocState.initial();

  @override
  Stream<PhoneVerificationBlocState> mapEventToState(
      PhoneVerificationBlocEvent event) async* {
