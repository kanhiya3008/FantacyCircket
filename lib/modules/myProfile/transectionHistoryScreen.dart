...
import 'package:frolicsports/models/transactionResponse.dart';
...
class _TransectionHistoryScreenState extends State<TransectionHistoryScreen> {
  ...
  var transactionModiFiedDataList = List<TransactionModiFiedDataList>();
        ...
        return StickyHeaderBuilder(
          ...
          content: Column(
            children: <Widget>[
              ...
              new Container(
                  padding: EdgeInsets.all(16),
                  child: getSubList(transactionModiFiedDataList[index])),
            ],
          ),
        );
      },
