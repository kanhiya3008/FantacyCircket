          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return PlayersPointInfoView(
                  ...
                  //isMach: isSelectedP(playingList[index].playerName),
                  clickAll: () {
                    showModalBottomSheet<void>(
                      ...
                      builder: (
                        BuildContext context,
                          ...
                          PlayersProfile(
                        pData: playingList[index],
                        //slectedPlist: widget.slectedPlist,
                      ),
                    );
                  });
            },
...
class PlayersPointInfoView extends StatelessWidget {
  ...
  const PlayersPointInfoView(
      {Key key, this.pData, this.tabtype, this.isMach, this.clickAll})
      : super(key: key);
...
class PlayersProfile extends StatefulWidget {
  final Playing11 pData;
  // final List<MypStringList> slectedPlist;
