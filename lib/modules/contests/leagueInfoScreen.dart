...
import 'package:frolicsports/models/leagueMemberListResponse.dart' as leagues;
import 'package:frolicsports/models/leagueMemberTeamResponse.dart' as leagueMember;
import 'package:frolicsports/models/scheduleResponseData.dart';
import 'package:frolicsports/models/scorecardResponce.dart';
import 'package:frolicsports/models/shedualResults.dart';
import 'package:frolicsports/models/userData.dart';
import 'package:frolicsports/modules/contests/contestsPoolView.dart';
import 'package:frolicsports/modules/contests/contestsScreen.dart';
import 'package:frolicsports/modules/contests/leagueTeamPreview.dart';
import 'package:frolicsports/modules/contests/playersPointInfoScreen.dart';
...
import 'package:frolicsports/modules/joinContest/teamSelectionScreen.dart';
import 'package:frolicsports/modules/myProfile/publicProfile.dart';
...
class _LeagueInfoScreenState extends State<LeagueInfoScreen> with SingleTickerProviderStateMixin {
  ...
  var leagueMemberList = List<leagues.LeagueMember>();
  var isProsses = false;
  var isGetTeam = false;
  var listData = ContestsLeagueListData();
  var teamList = List<teamData.TeamData>();
  ...
  Future getTeamList() async {
    var team = await ApiProvider().getCreatedTeamList('${widget.matchDataForApp.matchUniqueId}');
    if (team != null && team.success == 1) {
      if (team.teamData.length > 0) {
        teamList = team.teamData;
      } else {
        teamList = List<teamData.TeamData>();
      }
    }
    if (!mounted) return;
    setState(() {});
              ...
              return Container(
                child: Column(
                  children: <Widget>[
                    ...
                    //           children: <Widget>[
                    //             Text(
                    //               '${int.tryParse(contestJoinedData.totalTeam.toString()) - int.tryParse(widget.contestJoinedData.remainingTeam.toString())}',
                    //               style: TextStyle(
                    //                 fontSize: ConstanceData.SIZE_TITLE14,
                    //                 fontWeight: FontWeight.bold,
                    //                 color: Colors.black,
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text(
                      ...
                      style: TextStyle(fontSize: 28, color: AllCoustomTheme.getBlackAndWhiteThemeColors(), fontWeight: FontWeight.bold),
                    ),
                  ),
                ],
              ),
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text(
                      ...
                      style: TextStyle(fontSize: 14, color: Colors.black.withOpacity(0.7), fontWeight: FontWeight.bold),
                    ),
                  ),
                ],
              ),
          ...
          Expanded(
            child: Container(
              ...
              child: widget.tabtype == TabType.Upcoming
                  ? Text(
                      'view all teams \nafter the deadline',
                      style: TextStyle(fontSize: ConstanceData.SIZE_TITLE12, color: AllCoustomTheme.getTextThemeColors()),
                    )
                            ...
                            child: Row(
                              children: <Widget>[
                                Text(
                                  ...
                                  style: TextStyle(fontSize: ConstanceData.SIZE_TITLE14, color: Colors.red),
                                ),
                              ],
                            ),
                          ),
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Container(
                          child: Text(
                            'Download Teams ',
                            style: TextStyle(fontSize: ConstanceData.SIZE_TITLE10, color: AllCoustomTheme.getTextThemeColors()),
                          ),
                        ),
                        Container(
                          padding: EdgeInsets.only(top: 2),
...
class LeaguesListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      color: leagueTeam.userId == 'pank'//TODO globals.userdata.userId
          ? AllCoustomTheme.getThemeData().primaryColor.withOpacity(0.1) : Colors.transparent,
      child: InkWell(
        onTap: () {
          allClick();
        },
                ...
                children: <Widget>[
                                    ...
                                    children: <Widget>[
                                      ...
                                      tabtype == TabType.Live
                                          ? Text(
                                              '  IN WINNING...',
                                              style:
                                                  TextStyle(fontSize: ConstanceData.SIZE_TITLE10, fontWeight: FontWeight.bold, color: Colors.green),
                                            )
                                          : Text(
                  ...
                  tabtype == TabType.Upcoming
                      ? Container(
                          width: 50,
                          height: 50,
                          child: leagueTeam.userId == 'pank'//TODO globals.userdata.userId
                              ? InkWell(
                                  onTap: () {
                                    swapeTeamClick();
                                  },
