...
class CreateContestScreen extends StatefulWidget {
  ...
  const CreateContestScreen({Key key, this.shedualData}) : super(key: key);
  @override
          ...
          new Container(
            ...
            child: new TextField(
              ...
              decoration: new InputDecoration(
                labelText: 'Give your Contest  a name.',
              ),
              onEditingComplete: () {},
            ),
          ),
  ...
  void setValidCalculation() {
    if (totalWinningamount > 0 &&
      ...
      if (entryfees < 5) {
        ...
        setState(() {
          finalEntryfee = double.tryParse('${entryfees.toStringAsFixed(2)}');
