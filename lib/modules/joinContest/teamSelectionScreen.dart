...
class _TeamSelectionScreenState extends State<TeamSelectionScreen> {
  ...
  Future getTeamList() async {
    ...
    var team =
        await ApiProvider().getCreatedTeamList('${widget.matchDataForApp.matchUniqueId}');
    if (team.success == 1) {
      ...
      children: <Widget>[
        Container(
          ...
          child: Text(
            ...
            textAlign: TextAlign.center,
            style: TextStyle(fontSize: ConstanceData.SIZE_TITLE16),
          ),
        ),
        Divider(
          height: 1,
...
class _JoinTeamViewState extends State<JoinTeamView> {
  ...
  Future getTeamDeatil() async {
    ...
    if (data.success == 1 && data.playerList.length > 0) {
      ...
      // data.response.squads[0].players.forEach((player) {
      //   player.shortTeamName = data.response.squads[0].team.abbr.toUpperCase();
      //   players.add(player);
      // });
      // data.response.squads[1].players.forEach((player) {
      //   player.shortTeamName = data.response.squads[1].team.abbr.toUpperCase();
      //   players.add(player);
      // });
      ...
      players.forEach((p) {
        ...
        if (isMach(p.title)) {
//          if (widget.matchDataForApp.firstTeamLogo.a.shortName.toLowerCase() ==
//              p.teamName.toLowerCase()) {
//            teamA += 1;
//          }
//          if (widget.matchDataForApp.teamLogo.b.shortName.toLowerCase() ==
//              p.teamName.toLowerCase()) {
//            teamB += 1;
//          }
          if (widget.matchDataForApp.firstTeamShortName.toUpperCase() ==
              p.teamName.toUpperCase()) {
            teamA += 1;
          }
          if (widget.matchDataForApp.secondTeamShortName.toUpperCase() ==
              p.teamName.toUpperCase()) {
            teamB += 1;
          }
        }
        ...
        children: <Widget>[
          Container(
            child: Column(
              children: <Widget>[
                Text(
//                  widget.matchDataForApp.teamLogo.a.shortName,
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                Text(
//                  widget.matchDataForApp.teamLogo.b.shortName,
