...
class _LoginViewState extends State<LoginView> {
  ...
  String _validateEmail(String value) {
    return value.isEmpty
        ...
        : !Validators().emailValidator(value) ? 'Email is not valid' : null;
  }
          ...
          Container(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                child: Padding(
                  padding:
                      EdgeInsets.only(top: 10, left: 75, right: 75, bottom: 10),
                  child: Text(
                    'Login',
  ...
  void _submit() async {
    ...
    try {} catch (e) {
      Dialogs.showDialogWithOneButton(context, "Error", e.message);
    }
  }
}
